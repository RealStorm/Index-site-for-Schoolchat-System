	...
	<head>
		...
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,700,900">
		...
		<body>
			<header>
				<a href="../index.php"><img src="../img/schoolchattlogo.png" alt="Logo" class="logo"></a>			
			</header>
			<main>
				<div id="form-divlog">
					<form action="pages/UserLogin.php" method="post" id="form-log">
						<div class="input-box">
							...
							<input type="email" name="UserMail" maxlength="20" placeholder="Email" class="form-input">
						</div>
						<div class="input-box">
				...
				<div id="form-divreg">
					<form action="pages/InsertUser.php" method="post" id="form-reg">
						<div class="input-box">
							...
							<input type="text" name="UserName" maxlength="20" placeholder="Namn" class="form-input">
						</div>
						<div class="input-box">
							<i class="fa fa-envelope" aria-hidden="true"></i>
							<input type="email" name="UserMail" maxlength="35" placeholder="Email" class="form-input">
						</div>							
						<div class="input-box">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input type="password" name="UserPassword" placeholder="Lösenord" class="form-input">
			...
			<footer>
				...
				<span class="footer-text">School-Chatt © 2016</span>
			</footer>
		</body>
	</html>
